...
#Har prøvet forskellige c og se nedenunder scoren.
# C = 1000 => Score = 0.9230769230769231
# C = 500 => Score =  0.9230769230769231
# C = 100 => Score =  0.9230769230769231
# C = 50 => Score =   0.9230769230769231
# C = 10 => Score =   0.9230769230769231
# C = 1 => Score =    0.8461538461538461
# C = 0.5 => Score =  0.8461538461538461
# C = 0.1 => Score =  0.7692307692307693

h = .02 # step size in the mesh
# we fit the data.
logreg.fit(X, y)
#The score method in this code is used to evaluate the accuracy of the trained logistic regression model on the input data X and target variable y.
