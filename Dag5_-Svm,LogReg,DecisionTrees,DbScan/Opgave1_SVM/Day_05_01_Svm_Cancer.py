...
#clf = svm.SVC(kernel='rbf', C=1, gamma=0.000001) # Also test Linear Kernel #bruges til ikke linaer funktioner.
clf = svm.SVC(kernel='linear', C=1) # Also test Linear Kernel
